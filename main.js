...
function generateReceipt(receiptItems, totalPrice) {
    ...
    for (let indexOfReceiptItems = 0; indexOfReceiptItems < receiptItems.length; indexOfReceiptItems++) {
        receipt += `Name: ${receiptItems[indexOfReceiptItems].name}, Quantity: ${receiptItems[indexOfReceiptItems].quantity}, Unit price: ${receiptItems[indexOfReceiptItems].unitPrice} (yuan), Subtotal: ${receiptItems[indexOfReceiptItems].subtotalPrice} (yuan)\n`
    }
